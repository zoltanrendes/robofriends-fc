...
-   it is in TypeScript
-   it uses function components instead of class components
-   it uses redux and selector hooks to access the redux store's state.
...
-   finish the tests for the components
...
To spot linting errors

### `yarn precommit`

To run prettier and linter before commit
